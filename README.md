...
6. **Plan de Desarrollo Urbano 2040** — zonificación secundaria oficial del
   PDUCA 2040 ev.2 (IMPLAN Aguascalientes), extraída de su visor ArcGIS
   Online. Solo municipio de Aguascalientes.
...
data/
  ...
  ags_pdu.geojson            # 32 polígonos de zonificación secundaria PDUCA 2040 (uso, grupo, hectáreas)
  raw/                       # insumos INEGI, Periódico Oficial y webmap IMPLAN (no editar)
scripts/
  ...
  build_pdu.py               # convierte el webmap ArcGIS del IMPLAN (PDUCA 2040) a GeoJSON
web/
...
| Zonificación PDU | IMPLAN Aguascalientes, PDUCA 2040 ev.2 — webmap ArcGIS Online del [visor público](https://www.arcgis.com/apps/View/index.html?appid=fdd1339456bb4d3889a11916cedb9831) (item `66d60c4f75b44365ae55f6656400da93`) | `data/raw/pduca_webmap.json` |
