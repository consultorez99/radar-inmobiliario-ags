...
function leemeSIG(descripcionZona, conFraccion) {
  return [
    ...
    "Sistema de referencia: EPSG:32613 — WGS 84 / UTM zona 13N, en METROS.",
    "  (la que cubre Aguascalientes; va declarado en el .prj de cada capa)",
    "Atributos en UTF-8 (ver .cpg).",
    "",
    "CAPAS",
